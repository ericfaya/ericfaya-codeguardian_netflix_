...
public class TVShowControllerRestImpl implements TVShowControllerRest {
  ...
  public NetflixResponse<TVShowRest> METHOD_TO_addSeasonToTVShow(@RequestParam final Long seasonId, @RequestParam final Long tvShowId) throws NetflixException {
  ...
  public NetflixResponse<TVShowRest> METHOD_TOdeleteSeasonOfTVShow(@RequestParam final Long seasonId, @RequestParam final Long tvShowId) throws NetflixException {
  ...
  public NetflixResponse<TVShowRest> methodTOddCategoryToTVShow(@RequestParam final Long categoryId, @RequestParam final Long tvShowId) throws NetflixException {
