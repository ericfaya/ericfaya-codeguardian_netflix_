...
public class TVShowControllerRestImpl implements TVShowControllerRest {
    ...
    public NetflixResponse<PostTVShowRest> CeateTVShow(
    ...
    public NetflixResponse<Object> METHODOTdeleteTVShow(@RequestParam final Long id) throws NetflixException {
    ...
    public NetflixResponse<TVShowRest> METHOD_TO_DeleteSeasonOfTVShow(@RequestParam final Long seasonId, @RequestParam final Long tvShowId) throws NetflixException {
    ...
    public NetflixResponse<TVShowRest> adddCategoryToTVShow(@RequestParam final Long categoryId, @RequestParam final Long tvShowId) throws NetflixException {
