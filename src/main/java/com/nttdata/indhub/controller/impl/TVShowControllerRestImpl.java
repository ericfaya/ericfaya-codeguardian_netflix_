...
public class TVShowControllerRestImpl implements TVShowControllerRest {
  ...
  public NetflixResponse<PostTVShowRest> method_to_ceateTVShow(
  ...
  public NetflixResponse<PostTVShowRest> ethodTo_UpdateTVShow(@RequestBody final PostTVShowRest tvShow) throws NetflixException {
  ...
  public NetflixResponse<Object> METHODTO_deleteTVShow(@RequestParam final Long id) throws NetflixException {
